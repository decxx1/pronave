...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      CONTACT_HOURS_ES: envField.string({ context: 'client', access: 'public', optional: true }),
      CONTACT_HOURS_EN: envField.string({ context: 'client', access: 'public', optional: true }),
      ...
      CONTACT_TERMINAL1_HOURS_ES: envField.string({ context: 'client', access: 'public', optional: true }),
      CONTACT_TERMINAL1_HOURS_EN: envField.string({ context: 'client', access: 'public', optional: true }),
      ...
      CONTACT_TERMINAL2_HOURS_ES: envField.string({ context: 'client', access: 'public', optional: true }),
      CONTACT_TERMINAL2_HOURS_EN: envField.string({ context: 'client', access: 'public', optional: true }),
      ...
      CONTACT_CHILE_HOURS_ES: envField.string({ context: 'client', access: 'public', optional: true }),
      CONTACT_CHILE_HOURS_EN: envField.string({ context: 'client', access: 'public', optional: true }),
